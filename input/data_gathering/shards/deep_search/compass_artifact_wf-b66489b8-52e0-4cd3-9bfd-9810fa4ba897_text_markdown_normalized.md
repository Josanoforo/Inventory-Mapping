...
Normalized from non-canonical GROUP A/B/C/D format. Original file preserved unchanged.

---

## Part 1 — Clean findings (direct_verified)

### F-01: Marketplace location and category structure (18 categories)
...
**Source:** https://payhip.com/marketplace
**source_type:** search_results_page
**Date:** Accessed April 2026; page undated
**Notes:** "lifestle" is a typo present on the actual page (Fitness & Health description). The top nav bar shows a subset: "All | 3D | Roblox | Crafts | Design | Drawing & Painting | Music & Sound Design | Films | More" Original ID: A1.
**verification_status:** direct_verified

---

### F-02: Marketplace discovery mechanisms — sort, price filter, rating filter
...
**source_type:** search_results_page
**Date:** Accessed April 2026; page undated
**Notes:** Identical filter UI confirmed on /marketplace/3d, /marketplace/crafts, /marketplace/roblox. Products themselves are JavaScript-rendered and not visible in static HTML fetch. Original ID: A2.
**verification_status:** direct_verified

---

### F-03: Design category — 13 subcategories
...
**source_type:** search_results_page
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A3.
**verification_status:** direct_verified

---

### F-04: 3D category — 6 subcategories
...
**Source:** https://payhip.com/marketplace/3d
**source_type:** search_results_page
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A4.
**verification_status:** direct_verified

---

### F-05: Crafts category — 10 subcategories
...
**Source:** https://payhip.com/marketplace/crafts
**source_type:** search_results_page
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A5.
**verification_status:** direct_verified

---

### F-06: Roblox category — 9 subcategories
...
**Source:** https://payhip.com/marketplace/roblox
**source_type:** search_results_page
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A6.
**verification_status:** direct_verified

---

### F-07: Marketplace featured products section exists but is JS-rendered
...
**source_type:** search_results_page
**Date:** Accessed April 2026; page undated
**Notes:** This is an architectural finding — marketplace product grids use client-side JS rendering, while individual store pages render product listings server-side. Original ID: A7.
**verification_status:** direct_verified

---

### F-08: Marketplace help center — eligibility, scope, and tagging
...
**Source:** https://help.payhip.com/article/307-marketplace
**source_type:** article
**Date:** Last updated January 26, 2026
**Notes:** Original ID: A8.
**verification_status:** direct_verified

---

### F-09: Homepage — product types supported and featured showcase prices
...
**Notes:** Multi-currency: 8 products in USD, 1 in GBP (£4.50). Price range: £4.50–$30.00. Original ID: A9.
**verification_status:** direct_verified

---

### F-10: Virtual Ink store — ebook prices, sale patterns, popularity claim
...
**source_type:** product_listing
**Date:** Accessed April 2026; page undated
**Notes:** "OVER 10,000 COPIES SOLD" is seller-written text in the product description, not a platform-generated metric. No star ratings or review counts visible. 6 products observed with "View All" link suggesting more may exist. Original ID: A10.
**verification_status:** direct_verified

---

### F-11: NTT Solmare / Sol Store — ASMR and visual novel digital products, multi-language
...
**Source:** https://payhip.com/NTTsolmare
**source_type:** product_listing
**Date:** Accessed April 2026; page undated
**Notes:** 16 products visible on page 1; pagination indicates page 2 exists. Bundle price ($29.97) equals 3× individual price ($9.99). No reviews/ratings visible. No PayPal listed as payment method for this store (only Maestro, Mastercard, Visa, Discover). Original ID: A11.
**verification_status:** direct_verified

---

### F-12: Purge it with Patti store — E-books & Digital Journals collection
...
**source_type:** product_listing
**Date:** Accessed April 2026; page undated
**Notes:** No reviews/ratings visible. No sale indicators. Store tagline: "A faith- and plant-based approach for high-performing women ready for a physical, mental, and spiritual transformation" Original ID: A12.
**verification_status:** direct_verified

---

### F-13: Product page — Serviceform store, uniform £1.99 pricing with "On Sale" tag
...
**Source:** https://payhip.com/b/gniq2
**source_type:** product_listing
**Date:** Accessed April 2026; page undated
**Notes:** Product marked "On Sale" but price and original price both show £1.99. 11 products observed total on this page. All are Canva template products. Original ID: A13.
**verification_status:** direct_verified

---

### F-14: Homepage footer — resource hub reveals promoted product types
...
**source_type:** product_listing
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A14.
**verification_status:** direct_verified

---

### F-15: Homepage — navigation features dropdown shows product types and tools
...
**source_type:** product_listing
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A15.
**verification_status:** direct_verified

---

### F-16: Blog — recent content is competitor-comparison focused (April 2026)
...
**Source:** https://payhip.com/blog
**source_type:** blog
**Date:** April 2026
**Notes:** Original ID: A16.
**verification_status:** direct_verified

---

### F-17: Blog — 2024 features included wishlists and running sales
...
**Source:** https://payhip.com/blog/exciting-new-features-launched-in-2024/
**source_type:** blog
**Date:** 2024 (exact month not captured)
**Notes:** Original ID: A17.
**verification_status:** direct_verified

---

### F-18: Blog — 2025 feature roundup (no marketplace discovery features)
...
**Notes:** Original ID: A18.
**verification_status:** direct_verified

---

### F-19: Payhip SEO features — built-in, limited scope
...
**Source:** https://help.payhip.com/article/218-optimize-seo
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A19.
**verification_status:** direct_verified

---

### F-20: Payhip Collections system — seller-defined category groupings
...
**Source:** https://help.payhip.com/article/74-collections
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A20.
**verification_status:** direct_verified

---

### F-21: Payhip webhooks — 4 event types
...
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A21.
**verification_status:** direct_verified

---

### F-22: Payhip Public API (v2) — limited to license keys and coupons
...
**Source:** https://help.payhip.com/article/347-public-api
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A22.
**verification_status:** direct_verified

---

### F-23: Payhip mobile app — sales monitoring only, no product upload
...
**Source:** https://help.payhip.com/article/348-payhip-mobile-app
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A23.
**verification_status:** direct_verified

---

### F-24: Google Analytics 4 integration — built-in
...
**Source:** https://help.payhip.com/article/93-google-analytics
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A24.
**verification_status:** direct_verified

---

### F-25: Payhip free store themes
...
**Source:** https://payhip.com/themes
**source_type:** product_listing
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A25.
**verification_status:** direct_verified

---

### F-26: Payhip Partner (Affiliate) Program — 50% recurring commission
...
**Source:** https://payhip.com/partner-program
**source_type:** product_listing
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A26.
**verification_status:** direct_verified

---

### F-27: Payhip built-in analytics — Sales/Views, Visitor Sources, Conversion Rate
...
**Source:** https://payhip.com/features/analytics
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A27.
**verification_status:** direct_verified

---

### F-28: Payhip pricing plans — Free ($0 + 5%), Plus ($29/mo + 2%), Pro ($99/mo + 0%)
...
**source_type:** product_listing
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A28.
**verification_status:** direct_verified

---

### F-29: File type support — most types accepted, security exclusions listed
...
**Source:** https://help.payhip.com/article/59-adding-a-digital-product
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: A29.
**verification_status:** direct_verified
...
### F-P01: Zapier integration — connects Payhip with 8,000+ apps
...
**Source:** https://zapier.com/apps/payhip/integrations
**source_type:** database_profile
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B1.
**verification_status:** blocked_url_index_verified

---

### F-P02: Pabbly Connect — alternative automation platform for Payhip
...
**Source:** https://www.pabbly.com/connect/integrations/payhip/
**source_type:** database_profile
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B2.
**verification_status:** blocked_url_index_verified

---

### F-P03: Pipedream — developer-focused Payhip integration
...
**Source:** https://pipedream.com/apps/payhip
**source_type:** database_profile
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B3.
**verification_status:** blocked_url_index_verified

---

### F-P04: Make.com — community-developed Payhip module
...
**Source:** https://apps.make.com/payhip-p5v3ea
**source_type:** database_profile
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B4.
**verification_status:** blocked_url_index_verified

---

### F-P05: BookFunnel — ebook/audiobook delivery integration
...
**Source:** https://authors.bookfunnel.com/help/setup-payhip/
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B5.
**verification_status:** blocked_url_index_verified

---

### F-P06: Payhip WordPress plugin (official) — shortcode embedding
...
**Source:** https://wordpress.com/plugins/payhip-sell-ebooks
**source_type:** database_profile
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B6.
**verification_status:** blocked_url_index_verified

---

### F-P07: WP Payhip Integration (third-party by Robin Phillips)
...
**Source:** https://wordpress.org/plugins/wp-payhip-integration/
**source_type:** database_profile
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B7.
**verification_status:** blocked_url_index_verified

---

### F-P08: Common Ninja — search widget for Payhip stores
...
**Source:** https://www.commoninja.com/widgets/google-search/payhip
**source_type:** database_profile
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B8.
**verification_status:** blocked_url_index_verified

---

### F-P09: Fiverr — 549 Payhip freelance services available
...
**Source:** https://www.fiverr.com/gigs/payhip
**source_type:** search_results_page
**Date:** Accessed April 2026; page undated
**Notes:** "549 services available" observed in search results. Price range noted as from $5 to $150+. Original ID: B9.
**verification_status:** blocked_url_index_verified

---

### F-P10: Etsy — Payhip template market exists
...
**Source:** https://www.etsy.com/market/payhip_template
**source_type:** search_results_page
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B10.
**verification_status:** blocked_url_index_verified

---

### F-P11: Payhip blog — ebook pricing guidance ($2.99–$9.99 range, PWYW data)
...
**Source:** https://payhip.com/blog/ebook-pricing/
**source_type:** blog
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B11.
**verification_status:** blocked_url_index_verified

---

### F-P12: Payhip blog — launch pricing pattern ($19.99 regular / $9.99 launch)
...
**Source:** https://payhip.com/blog/how-to-sell-ebooks/
**source_type:** blog
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B12.
**verification_status:** blocked_url_index_verified

---

### F-P13: Payhip — resume template price range ($3–$60)
...
**Source:** https://payhip.com/sell-resume-templates-online
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B13.
**verification_status:** blocked_url_index_verified

---

### F-P14: Payhip — course video hosting costs $5/month
...
**Source:** https://payhip.com/features/sell-courses
**source_type:** product_listing
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B14.
**verification_status:** blocked_url_index_verified

---

### F-P15: TechHubInsider — recommended tools article for Payhip sellers
...
**Notes:** Original ID: B15.
**verification_status:** blocked_url_index_verified

---

### F-P16: Product page — VRChat avatar with limited-time pricing (€35 → €65)
...
**source_type:** product_listing
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B16.
**verification_status:** blocked_url_index_verified

---

### F-P17: Product page — software synth editor priced at €6.90
...
**source_type:** product_listing
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B17.
**verification_status:** blocked_url_index_verified

---

### F-P18: Product page — craft pattern with pay-what-you-want pricing
...
**source_type:** product_listing
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: B18.
**verification_status:** blocked_url_index_verified

---

### F-P19: Semrush — 10.55M monthly visits to payhip.com (Feb 2026)
...
**Notes:** Third-party estimate, not Payhip's own data. Original ID: B19.
**verification_status:** blocked_url_index_verified
...
### F-X01: Blogging Wizard — six product types on Payhip
...
**Source:** https://bloggingwizard.com/payhip-review/
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Consistent with directly verified homepage data (A9). Adds "Bundles" as a sixth type not explicitly shown as separate category on homepage. Original ID: C1.
**verification_status:** could_not_verify

---

### F-X02: Medium — Hazel Paradise compares Gumroad's "Discover" vs Payhip
...
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Provides comparative marketplace discovery context. Author uses both platforms. Original ID: C2.
**verification_status:** could_not_verify

---

### F-X03: Medium — Creator reports $33,000 in 3 months on Payhip
...
**Source:** https://edinajackson.medium.com/ive-made-33-000-on-payhip-in-3-months-without-posting-on-social-media-apps-73e3a29ab932
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Author (Edina Jackson) has multiple Medium posts about Payhip income and appears to be a content marketer/affiliate. Claims should be treated with skepticism. Original ID: C3.
**verification_status:** could_not_verify

---

### F-X04: Medium — Creator reports $5,543 in one week on Payhip
...
**Source:** https://edinajackson.medium.com/i-made-5-543-in-a-week-on-payhip-d1f33aff6d29
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: C4.
**verification_status:** could_not_verify

---

### F-X05: Medium — New seller reports $20 first-day revenue from 3 products at $1–$5
...
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Useful for price-testing pattern observation: $1, $5, and PWYW as entry-level price points. Original ID: C5.
**verification_status:** could_not_verify

---

### F-X06: Medium — "63% of new Payhip sellers make no sales in first 90 days"
...
**Source:** https://medium.com/@proacademia/5-reasons-your-payhip-digital-products-arent-selling-and-how-to-fix-it-in-2025-e09df9bbf805
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: C6.
**verification_status:** could_not_verify

---

### F-X07: CheckThat.ai — Free/Plus plan break-even at $967/month revenue
...
**Source:** https://checkthat.ai/brands/payhip/pricing
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Math checks out: $967 × 0.05 = $48.35; $29 + ($967 × 0.02) = $48.34. Verified by calculation. Original ID: C7.
**verification_status:** could_not_verify

---

### F-X08: Payhip blog — ebook statistics, positioning vs Amazon pricing
...
**Source:** https://payhip.com/blog/ebook-statistics/
**source_type:** blog
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: C8.
**verification_status:** could_not_verify

---

### F-X09: Payhip blog — Canva templates selling at ~$10, Etsy benchmark 1,000–3,000 sales
...
**Source:** https://payhip.com/blog/how-to-sell-canva-templates/
**source_type:** blog
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: C9.
**verification_status:** could_not_verify

---

### F-X10: The Product Store — multi-category physical/digital store with prices $4.99–$80.00
...
**Notes:** Original ID: C10.
**verification_status:** could_not_verify

---

### F-X11: Whop.com — notes "limited SEO capabilities" on Payhip
...
**source_type:** article
**Date:** Accessed April 2026; page undated
**Notes:** Original ID: C11.
**verification_status:** could_not_verify

---

### F-X12: No product counts found anywhere
...
**Notes:** Absence finding — no data found. Original ID: D1.
**verification_status:** could_not_verify

---

### F-X13: No review counts or star ratings visible in static HTML
...
**Notes:** Absence finding — no data found. Original ID: D2.
**verification_status:** could_not_verify

---

### F-X14: No /explore URL exists on Payhip
...
**Notes:** Absence finding — no data found. Original ID: D3.
**verification_status:** could_not_verify

---

### F-X15: No Payhip-specific Chrome extensions found
...
**Notes:** Absence finding — no data found. Original ID: D4.
**verification_status:** could_not_verify

---

### F-X16: No dedicated Payhip analytics dashboard tools found
...
**Notes:** Absence finding — no data found. Original ID: D5.
**verification_status:** could_not_verify

---

### F-X17: No dedicated Payhip consulting firms found
...
**Notes:** Absence finding — no data found. Original ID: D6.
**verification_status:** could_not_verify

---

### F-X18: No public data on category dominance or catalog composition breakdown
...
**Notes:** Absence finding — no data found. Original ID: D7.
**verification_status:** could_not_verify

---

### F-X19: No blog posts about marketplace discovery improvements or new category additions
...
**Notes:** Absence finding — no data found. Original ID: D8.
**verification_status:** could_not_verify

---

### F-X20: No pricing distribution data found
...
**Auxiliary services documented:** Zapier (8,000+ apps), Pabbly Connect, Pipedream, Make.com (community), BookFunnel (ebook delivery), Official WordPress plugin, WP Payhip Integration (third-party), WP Payhip Sell Digital (third-party), Common Ninja search widget, Fiverr freelance services (549 listed), Etsy template market, TidyCal, MailerLite, Carrd, TinyPNG, Fathom Analytics, SurferSEO (all recommended for Payhip in third-party article), Payhip Partner Program (50% recurring), Free store themes, Public API v2 (license keys + coupons), Webhooks (4 events), Mobile app (monitoring only)
**Notes:** Absence finding — no data found. Original ID: D9.
**verification_status:** could_not_verify
