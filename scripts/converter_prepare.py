...
Uso:
    python scripts/converter_prepare.py
    python scripts/converter_prepare.py --batch-size 50
    python scripts/converter_prepare.py --input-dir working/data_gathering/findings
"""
